...
asymptomatic %>% 
  ...
  summarize(mean(infectiousness, na.rm = TRUE))
```
Compare Incidence of Undergraduates and Graduate Year 1 vs those that are Graduate Year 2 and doctorate students
```{r}
...
Compare Incidence of RFF for different PH programs
```{r}
table(roster$program)
...
incidence_epi = 38/75
incidnece_glepi = 18/29
incidence_gh = 12/29
incidence_otherprs = 13/21
```
