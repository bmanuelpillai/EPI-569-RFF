...
i <- incidence(r0_df)
mu <- (med_incubation + (0.5*med_duration))/24 #replace with mean generation time
sigma <- (med_incubation + (0.5*med_duration))/24 #replace with standard deviation of generation time
